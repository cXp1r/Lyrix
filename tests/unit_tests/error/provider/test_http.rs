...
fn bad_request_display() {
    let e = HttpError::BadRequest { url: "https://api.test/v1".into() };
...
fn unauthorized_display() {
    let e = HttpError::Unauthorized { url: "https://api.test".into() };
...
fn forbidden_display() {
    let e = HttpError::Forbidden { url: "https://api.test".into() };
...
fn not_found_display() {
    let e = HttpError::NotFound { url: "https://api.test/404".into() };
...
fn too_many_requests_display() {
    let e = HttpError::TooManyRequests { url: "https://api.test".into() };
...
fn server_error_display() {
    let e = HttpError::ServerError { url: "https://api.test".into() };
...
fn bad_gateway_display() {
    let e = HttpError::BadGateway { url: "https://api.test".into() };
...
fn service_unavailable_display() {
    let e = HttpError::ServiceUnavailable { url: "https://api.test".into() };
...
#[test]
fn redirect_display() {
    let e = HttpError::Redirect { status: 301, url: "https://old.test".into() };
...
fn other_status_display() {
    let e = HttpError::OtherStatus { status: 418, url: "https://teapot.test".into() };
...
#[test]
fn timeout_display() {
    let e = HttpError::Timeout { url: "https://slow.test".into() };
...
#[test]
fn http_error_debug() {
    let e = HttpError::NotFound { url: "https://x.com".into() };
    let dbg = format!("{:?}", e);
